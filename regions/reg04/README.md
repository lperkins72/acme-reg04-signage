...
This folder is the region-default content layer for `reg04`.
...
- `regions/reg04/data/primary-assets.json`
- `regions/reg04/data/primary.json`
- `regions/reg04/data/footer.json`
- `regions/reg04/data/primaryending.json`
- `regions/reg04/assets/primary/manifest.json`
- `regions/reg04/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg04`.
